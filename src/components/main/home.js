...
export default () => (
  <div style={styleHome}>
    ...
    <div style={styleBody}>
      <p>
         Am quite bad at this kind of thing, talking about myself, it allways sounds
         so corny, atleast to me it does. Anyways, what I think is important to know about
         me is that I like to learn and build stuff. In my spare time am ussually
         building something or programming and learning a hole bunch along the way.
        <br />
        <br />
         ...
         available 3D CAD software, ProtocaseDesigner, at Protocaseas
         Software Engineer.
        <br />
        <br />
        ...
        it is not the best but hopefully useable.
      </p>
    </div>
  </div>
);
